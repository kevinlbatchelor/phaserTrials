...
export default class Player {
    ...
    update() {
        ...
        if ((keys.space.isDown && this.getInventory().potions > 0 && this.getInventory().earthSpell) || (keys.ctrl.isDown && this.getInventory().potions > 0 && this.getInventory().earthSpell)) {
            let pt = {
